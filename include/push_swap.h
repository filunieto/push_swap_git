...
void			extract_inpt(t_head_list *head, \
				char **array_words, size_t *posicion);
...
void			push_topushed(t_head_list *head_pusher, \
				t_head_list *head_pushed);
...
void			free_all_error(t_head_list *head_a, \
				t_head_list *head_b, char *line);
